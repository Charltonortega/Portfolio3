            ...
            >
              {projectsData.map((project, index: number) => (
                ...
                >
                  ...
                  <div className="right-content relative h-[40rem] overflow-hidden rounded-xl w-[60%] transition-all duration-200 shadow-2xl">
                    <img
                      src={project.image}
            ...
            {projectsData.map((project, index: number) => (
              ...
              >
                ...
                <img
                  src={project.image}
                  alt={project.image}
                  className="h-[35vh] w-full object-cover object-middle rounded-3xl"
                />
